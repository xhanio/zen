...
type Card interface {
	common.Service
	Create(ctx context.Context, title, content, groupID string, tagNames []string, parentCardID, sourceConversationID *string, format *string, levelEntryID *string, genesis *string, reference *api.ReferenceSpec, summary *string, attr entity.SnapshotAttribution) (*entity.Card, error)
	...
	Update(ctx context.Context, id string, title, content, groupID *string, position *int, tagNames *[]string, format *string, levelEntryID *string, clearLevelEntry bool, genesis *string, summary *string, attr entity.SnapshotAttribution) (*entity.Card, error)
	...
	Decompose(ctx context.Context, req api.DecomposeRequest, attr entity.SnapshotAttribution) (*api.DecomposeResponse, error)
