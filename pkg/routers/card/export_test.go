...
// Test-only surface. This file is part of package card but compiles only
// under `go test`, so the external card_test package can reach the concrete
...
func NewForTest(svc model.Card) *RouterForTest {
